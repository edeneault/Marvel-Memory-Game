...
// if scoreboard values empty set local storage and mark-up
// else set values from local storage
...
// handle click event - control flow
function handleCardClick(event) {
  ...
  if (previousClicked === divClicked) {
    console.log(`Clicked same card as previous`);
